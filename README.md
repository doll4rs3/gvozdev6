...
<body>
    ...
    <div class="tasks">
        ...
        <div class="task">
            ...
            <img src="screenshots/2.png" alt="Иллюстрация к задаче 2">
        </div>
        <div class="task">
            <h2>Задача 3</h2>
            ...
            <img src="screenshots/3.png" alt="Иллюстрация к задаче 3">
        </div>
        <div class="task">
            <h2>Задача 4</h2>
            ...
            <img src="screenshots/4.png" alt="Иллюстрация к задаче 4">
        </div>
        <div class="task">
            <h2>Задача 5</h2>
            ...
            <img src="screenshots/5.png" alt="Иллюстрация к задаче 5">
        </div>
        <div class="task">
            <h2>Задача 6</h2>
        ...
        <div class="task">
            ...
            <img src="screenshots/7.png" alt="Иллюстрация к задаче 7">
        </div>
        <div class="task">
            <h2>Задача 8</h2>
            ...
            <img src="screenshots/8.png" alt="Иллюстрация к задаче 8">
        </div>
        <div class="task">
            <h2>Задача 9</h2>
            ...
            <img src="screenshots/9.png" alt="Иллюстрация к задаче 9">
        </div>
        <div class="task">
            <h2>Задача 10</h2>
            ...
            <img src="screenshots/10.png" alt="Иллюстрация к задаче 10">
        </div>
        <div class="task">
            <h2>Задача 11</h2>
            ...
            <img src="screenshots/11.png" alt="Иллюстрация к задаче 11">
        </div>
        <div class="task">
            <h2>Задача 12</h2>
        ...
        <div class="task">
            ...
            <img src="screenshots/13.png" alt="Иллюстрация к задаче 13">
        </div>
        <div class="task">
            <h2>Задача 14</h2>
            ...
            <img src="screenshots/14.png" alt="Иллюстрация к задаче 14">
        </div>
        <div class="task">
            <h2>Задача 15</h2>
            ...
            <img src="screenshots/15.png" alt="Иллюстрация к задаче 15">
        </div>
        <div class="task">
            <h2>Задача 16</h2>
            ...
            <img src="screenshots/16.png" alt="Иллюстрация к задаче 16">
        </div>
        <div class="task">
            <h2>Задача 17</h2>
            ...
            <img src="screenshots/17.png" alt="Иллюстрация к задаче 17">
        </div>
        <div class="task">
            <h2>Задача 18</h2>
            ...
            <img src="screenshots/18.png" alt="Иллюстрация к задаче 18">
        </div>
        <div class="task">
            <h2>Задача 19</h2>
            ...
            <img src="screenshots/19.png" alt="Иллюстрация к задаче 19">
        </div>
        <div class="task">
            <h2>Задача 20</h2>
            ...
            <img src="screenshots/20.png" alt="Иллюстрация к задаче 20">
        </div>
        <div class="task">
            <h2>Задача 21</h2>
            <p>Создайте класс `Vehicle` с виртуальной функцией `fuelEfficiency()`, которая выбрасывает исключение при некорректных данных. Реализуйте классы `Car` и `Truck`.</p>
            <img src="screenshots/21.png" alt="Иллюстрация к задаче 21">
        </div>
        <div class="task">
            <h2>Задача 22</h2>
            <p>Реализуйте класс `User` с виртуальной функцией `login()`, которая выбрасывает исключение при неверном пароле. Создайте производные классы `AdminUser` и `RegularUser`.</p>
            <img src="screenshots/22.png" alt="Иллюстрация к задаче 22">
        </div>
        <div class="task">
            <h2>Задача 23</h2>
            <p>Напишите базовый класс `Shape` с виртуальной функцией `scale()`, которая выбрасывает исключение при отрицательном масштабе. Реализуйте классы `Circle` и `Square`.</p>
            <img src="screenshots/23.png" alt="Иллюстрация к задаче 23">
        </div>
        <div class="task">
            <h2>Задача 24</h2>
            <p>Создайте класс `Library` с виртуальной функцией `borrowBook()`, которая выбрасывает исключение, если книга недоступна. Реализуйте классы `FictionLibrary` и `NonFictionLibrary`.</p>
            <img src="screenshots/24.png" alt="Иллюстрация к задаче 24">
        </div>
        <div class="task">
            <h2>Задача 25</h2>
            ...
            <img src="screenshots/25.png" alt="Иллюстрация к задаче 25">
        </div>
        <div class="task">
            <h2>Задача 26</h2>
            <p>Создайте класс `Shape` с виртуальной функцией `rotate()`, которая выбрасывает исключение при некорректных углах. Реализуйте классы `Triangle` и `Rectangle`.</p>
            <img src="screenshots/26.png" alt="Иллюстрация к задаче 26">
        </div>
        <div class="task">
            <h2>Задача 27</h2>
            <p>Реализуйте класс `Payment` с виртуальной функцией `processPayment()`, которая выбрасывает исключение при недостаточном балансе. Создайте классы `CreditCardPayment` и `PayPalPayment`.</p>
            <img src="screenshots/27.png" alt="Иллюстрация к задаче 27">
        </div>
        <div class="task">
            <h2>Задача 28</h2>
            <p>Напишите базовый класс `ExceptionHandler` с виртуальной функцией `handle()`, которая выбрасывает исключение при ошибке. Реализуйте классы `FileExceptionHandler` и `NetworkExceptionHandler`.</p>
        ...
        <div class="task">
            <h2>Задача 29</h2>
            <p>Создайте класс `Course` с виртуальной функцией `enroll()`, которая выбрасывает исключение при переполнении группы. Реализуйте классы `OnlineCourse` и `OfflineCourse`.</p>
            <img src="screenshots/29.png" alt="Иллюстрация к задаче 29">
        </div>
        <div class="task">
            <h2>Задача 30</h2>
            <p>Реализуйте класс `ShoppingCart` с виртуальной функцией `checkout()`, которая выбрасывает исключение при пустой корзине. Создайте классы `RegularCart` и `DiscountedCart`.</p>
            <img src="screenshots/30.png" alt="Иллюстрация к задаче 30">
        </div>
        <div class="task">
            <h2>Задача 31</h2>
            ...
            <img src="screenshots/31.png" alt="Иллюстрация к задаче 31">
        </div>
        <div class="task">
            <h2>Задача 32</h2>
            ...
            <img src="screenshots/32.png" alt="Иллюстрация к задаче 32">
        </div>
        <div class="task">
            <h2>Задача 33</h2>
            ...
            <img src="screenshots/33.png" alt="Иллюстрация к задаче 33">
        </div>
        <div class="task">
            <h2>Задача 34</h2>
            ...
            <img src="screenshots/34.png" alt="Иллюстрация к задаче 34">
        </div>
        <div class="task">
            <h2>Задача 35</h2>
            ...
            <img src="screenshots/35.png" alt="Иллюстрация к задаче 35">
        </div>
        <div class="task">
            <h2>Задача 36</h2>
            ...
            <img src="screenshots/36.png" alt="Иллюстрация к задаче 36">
        </div>
        <div class="task">
            <h2>Задача 37</h2>
            ...
            <img src="screenshots/37.png" alt="Иллюстрация к задаче 37">
        </div>
        <div class="task">
            <h2>Задача 38</h2>
            ...
            <img src="screenshots/38.png" alt="Иллюстрация к задаче 38">
        </div>
        <div class="task">
            <h2>Задача 39</h2>
            ...
            <img src="screenshots/39.png" alt="Иллюстрация к задаче 39">
        </div>
        <div class="task">
            <h2>Задача 40</h2>
            ...
            <img src="screenshots/40.png" alt="Иллюстрация к задаче 40">
        </div>
        ...
        <div class="task">
            ...
            <img src="screenshots/15.png" alt="Иллюстрация к задаче 41">
        </div>
        <div class="task">
            <h2>Задача 42</h2>
            ...
            <img src="screenshots/22.png" alt="Иллюстрация к задаче 42">
        </div>
        <div class="task">
            <h2>Задача 43</h2>
            ...
            <img src="screenshots/33.png" alt="Иллюстрация к задаче 43">
        </div>
        <div class="task">
            <h2>Задача 44</h2>
            ...
            <img src="screenshots/7.png" alt="Иллюстрация к задаче 44">
        </div>
        <div class="task">
            <h2>Задача 45</h2>
            ...
            <img src="screenshots/19.png" alt="Иллюстрация к задаче 45">
        </div>
        <div class="task">
            <h2>Задача 46</h2>
            ...
            <img src="screenshots/28.png" alt="Иллюстрация к задаче 46">
        </div>
        <div class="task">
            <h2>Задача 47</h2>
            ...
            <img src="screenshots/3.png" alt="Иллюстрация к задаче 47">
        </div>
        <div class="task">
            <h2>Задача 48</h2>
            ...
            <img src="screenshots/11.png" alt="Иллюстрация к задаче 48">
        </div>
        <div class="task">
            <h2>Задача 49</h2>
            ...
            <img src="screenshots/25.png" alt="Иллюстрация к задаче 49">
        </div>
        <div class="task">
            <h2>Задача 50</h2>
            ...
            <img src="screenshots/40.png" alt="Иллюстрация к задаче 50">
        </div>
        ...
        <div class="task">
            ...
            <img src="screenshots/1.png" alt="Иллюстрация к задаче 51">
        </div>
        <div class="task">
            <h2>Задача 52</h2>
            ...
            <img src="screenshots/2.png" alt="Иллюстрация к задаче 52">
        </div>
        <div class="task">
            <h2>Задача 53</h2>
            ...
            <img src="screenshots/3.png" alt="Иллюстрация к задаче 53">
        </div>
        <div class="task">
            <h2>Задача 54</h2>
            ...
            <img src="screenshots/4.png" alt="Иллюстрация к задаче 54">
        </div>
        <div class="task">
            <h2>Задача 55</h2>
            ...
            <img src="screenshots/5.png" alt="Иллюстрация к задаче 55">
        </div>
        <div class="task">
            <h2>Задача 56</h2>
            ...
            <img src="screenshots/6.png" alt="Иллюстрация к задаче 56">
        </div>
        <div class="task">
            <h2>Задача 57</h2>
            ...
            <img src="screenshots/7.png" alt="Иллюстрация к задаче 57">
        </div>
        <div class="task">
            <h2>Задача 58</h2>
            ...
            <img src="screenshots/8.png" alt="Иллюстрация к задаче 58">
        </div>
        <div class="task">
            <h2>Задача 59</h2>
            ...
            <img src="screenshots/9.png" alt="Иллюстрация к задаче 59">
        </div>
        <div class="task">
            <h2>Задача 60</h2>
            ...
            <img src="screenshots/10.png" alt="Иллюстрация к задаче 60">
        </div>
        ...
        <div class="task">
            ...
            <img src="screenshots/11.png" alt="Иллюстрация к задаче 61">
        </div>
        <div class="task">
            <h2>Задача 62</h2>
            ...
            <img src="screenshots/12.png" alt="Иллюстрация к задаче 62">
        </div>
        <div class="task">
            <h2>Задача 63</h2>
            ...
            <img src="screenshots/13.png" alt="Иллюстрация к задаче 63">
        </div>
        <div class="task">
            <h2>Задача 64</h2>
            ...
            <img src="screenshots/14.png" alt="Иллюстрация к задаче 64">
        </div>
        <div class="task">
            <h2>Задача 65</h2>
            ...
            <img src="screenshots/15.png" alt="Иллюстрация к задаче 65">
        </div>
        <div class="task">
            <h2>Задача 66</h2>
            ...
            <img src="screenshots/16.png" alt="Иллюстрация к задаче 66">
        </div>
        <div class="task">
            <h2>Задача 67</h2>
            ...
            <img src="screenshots/17.png" alt="Иллюстрация к задаче 67">
        </div>
        <div class="task">
            <h2>Задача 68</h2>
            ...
            <img src="screenshots/18.png" alt="Иллюстрация к задаче 68">
        </div>
        <div class="task">
            <h2>Задача 69</h2>
            ...
            <img src="screenshots/19.png" alt="Иллюстрация к задаче 69">
        </div>
        <div class="task">
            <h2>Задача 70</h2>
            ...
            <img src="screenshots/20.png" alt="Иллюстрация к задаче 70">
        </div>
        ...
        <div class="task">
            ...
            <img src="screenshots/50.png" alt="Иллюстрация к задаче 71">
        </div>
        <div class="task">
            <h2>Задача 72</h2>
            ...
            <img src="screenshots/51.png" alt="Иллюстрация к задаче 72">
        </div>
        <div class="task">
            <h2>Задача 73</h2>
            ...
            <img src="screenshots/52.png" alt="Иллюстрация к задаче 73">
        </div>
        <div class="task">
            <h2>Задача 74</h2>
            ...
            <img src="screenshots/53.png" alt="Иллюстрация к задаче 74">
        </div>
        <div class="task">
            <h2>Задача 75</h2>
            ...
            <img src="screenshots/54.png" alt="Иллюстрация к задаче 75">
        </div>
        <div class="task">
            <h2>Задача 76</h2>
            ...
            <img src="screenshots/55.png" alt="Иллюстрация к зада
